...
const index = () => {
  ...
  const [userId, setUserId] = useState(
    localStorage.getItem("token")
      ? Object.keys(getParsedToken(localStorage.getItem("token"))).includes(
          "userid"
        )
        ? getParsedToken(localStorage.getItem("token")).userid
        : ""
      : ""
  );
        ...
        <form onSubmit={(event) => SavePersonalDetails(event)}>
            ...
            <div class="profile-pic">
              ...
              <img
                src={
                  imageBinary
                    ? imageBinary
                    : "https://www.nicepng.com/png/detail/514-5146455_premium-home-loan-icon-download-in-svg-png.png"
                }
                id="output"
                width="200"
              />
          ...
          <div className="row mt-4">
            <div className="col-md-3">
              <input
                type="submit"
                value={isDetailsAvailable ? "Update" : "Save"}
